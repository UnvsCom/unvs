...
uint256 hashGenesisBlock("0xee020549e6209403db5738cfc90634a5c5f69d2f07deeebf3a0bfebca5d4b6a6");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // UNVS: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // UNVS: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // UNVS: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x823630608ce1b685273aa25ee50c47ca8c82887845f79ce13b133aab76767c4a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04c18bd859f882a10bd185b8c34e0c24dbd566d6102a96adcbac23e59068f4284681c0eed22a8229459e7de0d4d11ee3673adf7bbc2bf0de1e6b1eed0de7b10883") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1675950595;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2088529066;

        if (fTestNet)
        {
            block.nTime    = 1675950573;
            block.nNonce   = 395648244;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xf8283dddac93d3a38d58d2ea084ac795034785c29f913ede1d36e19b8af831f8"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfu, 0xc1, 0xb9, 0xda }; // UNVS: increase each by adding 2 to bitcoin's value.
